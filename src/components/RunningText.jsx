const DEFAULT_RUNNING_TEXT = "Selamat datang di Biddokkes Polda NTB - Bidang Kedokteran & Kesehatan Polda NTB, melayani pelayanan kedokteran forensik, DVI & kesehatan kepolisian.";

const RunningText = ({ text }) => {
  const message =
    typeof text === "string" && text.trim() ? text.trim() : DEFAULT_RUNNING_TEXT;
